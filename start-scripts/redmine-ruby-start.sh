...
sudo echo "${DNS_EFS}:/ home/${USER_NAME}/redmine_file_storage nfs4 defaults,_netdev 0 0" >> /etc/fstab
sudo chmod 666 /home/${USER_NAME}/redmine_file_storage
sudo chmod 777 /home/${USER_NAME}/update.sh
